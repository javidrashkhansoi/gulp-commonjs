...
__Благодарности *[Евгению Андриканичу](https://www.youtube.com/c/FreelancerLifeStyle/featured)* и *[Сергею Микову](https://www.youtube.com/c/CodeQuestRu/featured)*__
...
- Создается файл *_font-face.scss* по пути **src/scss/block/** с готовым подключением шртифтов (рекомендуется проверить подключение и другие стили)
...
- Не используйте в названиях символы *#*, *!*, *$*, *^*, *&* и т.д.
